class Lore < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/e-a-s-t/lore/releases/download/v0.1.3/lore-darwin-arm64.tar.gz"
      sha256 "ee04b5a1320ab74711c76b8db8dfd4e643a8c344ae280ed649a5ac03c3ad8810"
    end
  end

  on_linux do
    url "https://github.com/e-a-s-t/lore/releases/download/v0.1.3/lore-linux-amd64.tar.gz"
