class Lore < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/e-a-s-t/lore-tui/releases/download/v0.1.5/lore-darwin-arm64.tar.gz"
      sha256 "909a1c4a010460658c85e4304d93089bfae51d7ff2dcf5f93c55036941b15c00"
    end
  end

  on_linux do
    url "https://github.com/e-a-s-t/lore-tui/releases/download/v0.1.5/lore-linux-amd64.tar.gz"
